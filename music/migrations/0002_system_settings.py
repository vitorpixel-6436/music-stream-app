# Generated migration for v2.1.0
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_formats', models.CharField(default='mp3,flac,wav,m4a,ogg', help_text='Comma-separated list of allowed audio formats', max_length=255)),
                ...
                ('default_theme', models.CharField(choices=[('glass', 'Apple Glass'), ('steam', 'Steam Gaming'), ('spotify', 'Spotify Minimal'), ('msi', 'MSI Gaming')], default='glass', max_length=20)),
